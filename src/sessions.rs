...
impl SessionManager {
    ...
    pub fn fork_session(&self, original_id: &str, new_id: Option<&str>) -> Result<Session, Box<dyn std::error::Error>> {
...
mod tests {
    ...
    fn test_fork_session() {
        ...
        assert_eq!(forked.messages[0], json!({"role": "user", "content": "hello"}));
